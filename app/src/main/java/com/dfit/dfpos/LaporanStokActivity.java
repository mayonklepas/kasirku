    ...
    private void gettanggal() {
        bimg_tanggal_dari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DatePickerDialog dpd = new DatePickerDialog(LaporanStokActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(LaporanStokActivity.this, android.Manifest.permission.READ_EXTERNAL_STORAGE)
                        ...
                        ActivityCompat.checkSelfPermission(LaporanStokActivity.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                                != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(LaporanStokActivity.this,
